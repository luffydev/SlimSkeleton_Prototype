...
class Template
{
    ...
    public function __construct()
    {
        ...
        $this->addTwigFunction('breadcrumb', $this, 'buildBreadCrumb');
    }

    public function addTwigFunction($pName, $pPtr, $pFuncName)
    {
        $function = new TwigFunction($pName, [$pPtr, $pFuncName]);                                       
    ...
    public function buildBreadCrumb ($separator = ' &raquo; ', $home = 'Home') {
